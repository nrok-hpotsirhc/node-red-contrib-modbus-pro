...
> **Current State (2026-06-08):** v0.1.0 released and finalization audit complete – all 11 implemented function codes (FC 01–06, 15, 16, 22, 23, 43/14) are validated. 646/646 automated tests passing, lint passing, an opt-in COM11 live connection smoke test verified separately (3/3 passing), and a dedicated COM11 19200 8E1 slave-4 FC23 smoke test available for manual execution. 7 Node-RED nodes. MS-8 (QA & Release) and MS-9 (Extended FCs) complete.
...
**Overall Progress: 9 / 12 milestones completed – 646 / 646 automated tests passing; opt-in COM11 live smoke test 3 / 3 passing; COM11 slave-4 FC23 smoke test added**
