...
| 2026-06-08 | MS-8 | Complete | RTU live hardware test hardened for Windows PowerShell/COM11: opt-in via `RTU_LIVE_TESTS=true`, direct Mocha invocation avoids npm path issues with `&` in workspace paths, and COM11 connection smoke test verified 3/3 passing. Main suite remains 646/646 passing |
